...
export function ActiveStaffCard({ activeStaff, totalStaff, onOpenModal }: ActiveStaffCardProps) {
  return (
    <Card className="rounded-2xl border-none shadow-md bg-linear-to-br from-[#0096C7] via-indigo-500 to-purple-600 text-white relative overflow-hidden flex flex-col justify-between">
      ...
      <CardContent className="py-3 px-3.5 relative z-5 flex-1 flex flex-col justify-between">
        <div>
          ...
          <div className="py-8 mt-2 flex items-baseline justify-between">
