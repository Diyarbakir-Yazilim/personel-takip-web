...
"[project]/src/components/ui/pwa-register.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function PwaRegister() {
    ...
    if ($[0] !== "5af39574f5e79902f38009899763e3cb7442e518355b0c15c0263b0bb625c4e1") {
        for(let $i = 0; $i < 2; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "5af39574f5e79902f38009899763e3cb7442e518355b0c15c0263b0bb625c4e1";
    }
    let t0;
...
function _PwaRegisterUseEffect() {
    if ("serviceWorker" in navigator) {
        const registerSW = _PwaRegisterUseEffectRegisterSW;
...
function _PwaRegisterUseEffectRegisterSW() {
    navigator.serviceWorker.register("/sw.js").then(_PwaRegisterUseEffectRegisterSWAnonymous).catch(_PwaRegisterUseEffectRegisterSWAnonymous2);
}
function _PwaRegisterUseEffectRegisterSWAnonymous2(err) {
    console.log("ServiceWorker registration failed: ", err);
}
function _PwaRegisterUseEffectRegisterSWAnonymous(registration) {
...
//# sourceMappingURL=_01362yw._.js.map